...
class JConfig
{
	...
	public $db = 'tecnolab_labsite';
	public $dbencryption = '';
	public $dbprefix = 'labs_';
	public $dbsslca = '';
	public $dbsslcert = '';
	public $dbsslcipher = '';
	public $dbsslkey = '';
	...
	public $force_ssl = '0';
	public $fromname = 'Tecnolabs - Agência Digital';
	public $frontediting = '1';
	public $gzip = '';
	public $helpurl = 'https://help.joomla.org/proxy?keyref=Help{major}{minor}:{keyref}&lang={langcode}';
	public $host = 'mysql591.itmnetworks.net:3306';
	public $lifetime = '15';
	...
	public $log_path = '/domains4/tecnolab/public_html/administrator/logs';
	public $log_priorities = array (
'0' => 'all'
);
	public $mailer = 'mail';
	public $mailfrom = 'contato@tecnolabs.info';
	public $mailonline = '1';
	public $massmailoff = '';
	...
	public $replytoname = '';
	public $robots = '';
	public $secret = '7CHTGRLpyctQXnh1XqYxqfMPfpwqsmbg';
	public $sef = '1';
	public $sef_rewrite = '';
	public $sef_suffix = '';
	...
	public $smtpuser = '';
	public $tmp_path = '/domains4/tecnolab/public_html/tmp';
	public $unicodeslugs = '';
	public $user = 'tecnolab_root';
}
